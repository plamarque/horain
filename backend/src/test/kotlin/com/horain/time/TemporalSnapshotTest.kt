...
class TemporalSnapshotTest {
    ...
    @Test
    fun fromZoned_matchesAnalyticsBoundsForUtcMonday() {
        val utc = ZoneId.of("UTC")
        val anchor = ZonedDateTime.parse("2025-03-10T12:00:00Z")
        val s = TemporalSnapshot.fromZoned(anchor, utc)
    ...
    @Test
    fun toLlmSummary_containsSameBoundsAsDataMap() {
        val utc = ZoneId.of("UTC")
        val s = TemporalSnapshot.fromZoned(ZonedDateTime.parse("2025-03-10T12:00:00Z"), utc)

        val llm = s.toLlmSummary()
