...
public class LlmChatService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - If the project doesn't exist, do NOT create it or log directly. Propose: "I don't know a project named X yet. Should I create it and log Y minutes?" and wait for explicit confirmation (yes/ok/create/go ahead). When the user replies yes, ok, create, or go ahead to that proposal, immediately call create_project then create_time_log with the project name and duration from the prior message.
