...
public class LlmChatService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - When listing entries for a specific project (e.g. "list entries for Horain"): if the user did not specify a date range, call get_current_datetime first and use a period that includes recent activity (e.g. startOfMonth to endOfMonth, or startOfWeek to endOfWeek). Do NOT use an arbitrary past period (e.g. October 2023); use the current month or week so that recent entries are included.
